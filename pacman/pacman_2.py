...
class Cenario(ElementoJogo):
    def __init__(self, tamanho, pac):
        ...
        self.pontos = 0
        #Estados possíveis -> 0 : Jogando / 1 : Pausado / 2 : GameOver / 3 : Ganhar
        self.estado = 0
        self.vidas = 5
        self.matriz = [
    ...
    def pintar_score(self, tela):
        pontos_x = 30 * self.tamanho #fora do cenário pintado
        pontos_img = fonte.render(f"Score: {self.pontos}", True, AMARELO, 0)
        vidas_img = fonte.render(f"Vidas: {self.vidas}", True, AMARELO, 0)
...
class Pacman(ElementoJogo, Movivel):
    def __init__(self, tamanho):
        ...
        self.vel_x = 0 #começa parado
        self.vel_y = 0 #começa parado
...
#Testar se não estiver importando este pacote
